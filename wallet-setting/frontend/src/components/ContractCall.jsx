...
export function ContractCall() {
  ...
  return (
    <>
      <StyledDeployContractButton disabled={!active || greetingContract ? true : false} onClick={handleDeployContract}>
        Deploy Greeting Contract
      </StyledDeployContractButton>
      <StyledGreetingDiv>
        <div>Contract address</div>
        <div>{greetingContract ? greetingContractAddr : 'Contract not yet deployed'}</div>
      </StyledGreetingDiv>
      <StyledLabel>
        <div>Greeting</div>
